...
class Api:
    def __init__(self, app: FastAPI, queue_lock: Lock):
        ...
        @self.router.get("/health", status_code=200)
        async def health():
            return {"status": "ok"}
    ...
    def predictapi(self, request: Request, endpoint: str):
        if endpoint == "txt2img":
            return self.text2imgapi(request)
        elif endpoint == "img2img":
            return self.img2imgapi(request)
        return None
    ...
    def init_script_args(
        self, request, selectable_scripts, selectable_idx, script_runner
    ):
    ...
    def text2imgapi(self, txt2imgreq: StableDiffusionTxt2ImgProcessingAPI):
        ...
        script_args = self.init_script_args(
            txt2imgreq, selectable_scripts, selectable_script_idx, script_runner
        )
